...
+ (CGFloat)heightForContent:(NSString *)content fontoOfText:(CGFloat)textFont spacingOfLabel:(CGFloat)spacing{
...
{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:ZYAppDelegate.window animated:YES];
