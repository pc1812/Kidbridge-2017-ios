...
@interface CardBookViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation CardBookViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadData{
    ...
    [parame setObject:_url forKey:@"uri"];
    ...
    [[HttpManager sharedManager] POST:_url parame:parame sucess:^(id success) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    PicBookModel *model = self.dataSource[indexPath.row];
