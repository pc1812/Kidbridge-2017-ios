...
@interface ThreeAgeViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)loadData{
    ...
    [parame setObject:@(_pageNum * kOffset) forKey:@"offset"];//kOffset
