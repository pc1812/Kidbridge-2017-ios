...
@interface MineCoNoViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation MineCoNoViewController
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        layout.itemSize = CGSizeMake(SCREEN_WIDTH - 36, 50 + (SCREEN_WIDTH - 36) *5/9);//210
