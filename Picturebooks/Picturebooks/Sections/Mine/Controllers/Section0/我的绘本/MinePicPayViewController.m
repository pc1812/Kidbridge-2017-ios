...
@interface MinePicPayViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation MinePicPayViewController
...
- (void)loadData{
    ...
    [parame setObject:@(0) forKey:@"free"];
