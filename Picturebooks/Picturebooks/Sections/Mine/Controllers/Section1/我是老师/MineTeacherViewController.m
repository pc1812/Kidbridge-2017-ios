...
@interface MineTeacherViewController ()<SegmentTapViewDelegate,FlipTableViewDelegate, UIScrollViewDelegate>
...
-(void)initFlipTableView{
    ...
    TeacherNoViewController *v1 = [[TeacherNoViewController alloc] init];
    [self addChildViewController:v1];
    [self.scrollView addSubview:v1.view];
    v1.view.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-PBNew64-44);
    
    TeacherBeginViewController *v2 = [[TeacherBeginViewController alloc] init];
